...
export const en: Dictionary = {
  ...
  account: {
    ...
    hours: {
      ...
      /* "Rejected" reads as a judgement of the person. This describes what
         happened to the entry, and matches the notification they were sent. */
      ...
      backToAccount: 'Back to my account',
      historyLede:
        'The record is complete and nothing is removed from it: a corrected entry stays visible with its reason, and so does one that was not verified.',
      awaiting: {
        zero: 'Nothing is waiting for review',
        one: 'One entry waiting for a supervisor',
        two: 'Two entries waiting for a supervisor',
        few: '{n} entries waiting for a supervisor',
        many: '{n} entries waiting for a supervisor',
      },
      verifiedNote: 'Counted towards your stage and your hours certificate.',
      pendingNote: 'Not counted until a supervisor verifies it.',
      countedUpToLabel: 'Counted up to',
      carriedExplain:
        'Your volunteering from before this site, recorded by the association in one entry. It is not a single day of work.',
      correctionTitle: 'Correction to an earlier entry',
      removedLabel: 'Removed',
      supersededNote: 'This entry was corrected later. It stays here for reference.',
      staffNoteLabel: 'Supervisor’s note',
    ...
    profile: {
      ...
      displayNameHint: 'What you are called on boards and public pages, if you have chosen to appear on them. Your full name still goes on certificates and your card.',
      bioHint: 'A line or two about you, read by the coordinator before they hand out roles.',
      interestsHint: 'The kinds of work you want — relief, children, environment. We use these to suggest activities to you instead of leaving you to hunt for them.',
      skillsHint: 'What you can actually do: first aid, driving, design, coordination. Coordinators search here when an activity needs a particular skill.',
      languagesHint: 'The languages you speak. Asked for whenever an activity needs interpreting, or families who do not speak Arabic.',
      completeness: {
        title: 'Your profile',
        lede: 'The fuller this is, the easier it is for a coordinator to put you on the right activity.',
        count: '{done} of {total}',
    ...
    certificate: {
      ...
      revokedKept: 'A revoked certificate stays on this page with the reason it was withdrawn. Nothing is removed from your record.',
      view: 'View',
    ...
    activities: {
      ...
      mineLede: 'What you signed up for, what you attended, and what was called off — each one said as what it is.',
      upcoming: 'Upcoming',
      past: 'Past',
      cancelled: 'Cancelled',
      ...
      outcome: {
        calledOff: 'Called off by the association',
        withdrawn: 'You withdrew',
        attended: 'Attended',
        // Not "did not attend": this describes what is on the supervisor's
        // sheet, not a verdict on the volunteer.
        absenceRecorded: 'No attendance recorded for you',
        awaitingRecord: 'Attendance not recorded yet',
        registered: 'Your place is held',
        waitlisted: 'On the waiting list',
      },
      calledOffTitle: 'Called off by the association',
      withdrawnTitle: 'Registrations you cancelled',
      calledOffNote: 'The association called this activity off, so it never took place. It says nothing about your attendance.',
      calledOffReason: 'Reason given: {reason}',
      withdrawnNote: 'You cancelled your registration for this activity.',
      awaitingRecordNote: 'The activity is over and the supervisor has not recorded attendance yet.',
      hoursCounted: '{duration} counted for you',
