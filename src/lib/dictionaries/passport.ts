...
export const passportAr: PassportStrings = {
  ...
  notACertificateTitle: 'ورقة أصدرتَها بنفسك، لا شهادة من الجمعية',
  /*
   ...
   */
  notACertificate:
    'هذه الورقة ملخّصٌ لسجلّك في منصّة جمعية تكافل، أصدرتَه أنت من حسابك في التاريخ المذكور أعلاه. ليست شهادةً أصدرتها الجمعية، ولا وثيقةً صادقت عليها، ولا يصحّ التعامل معها على أنّها مستندٌ مُوثَّق. الشهادات التي تصدرها الجمعية تحمل رمزاً خاصاً بها ولها صفحة تحقّق على موقعها؛ وهذه الورقة لا تحمل شيئاً من ذلك.',
  verifyHint:
    'للتحقّق من شهادةٍ حقيقية أصدرتها الجمعية، أدخل رمزها في صفحة التحقّق على موقعها. وللتثبّت ممّا ورد في هذه الورقة، راسل الجمعية مباشرةً.',
...
export const passportEn: PassportStrings = {
  ...
  notACertificateTitle: 'A record you generated yourself — not a certificate from the association',
  notACertificate:
    'This sheet is a summary of your record on the Takaful platform, generated by you from your own account on the date shown above. It is not a certificate issued by the association, it has not been attested by the association, and it should not be treated as a verified document. Certificates the association issues carry a code of their own and have a verification page on its website; this sheet carries neither.',
  verifyHint:
    'To check a genuine certificate the association issued, enter its code on the verification page of its website. To confirm anything written on this sheet, write to the association directly.',
