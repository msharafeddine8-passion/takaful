    ...
    // ---------------------------------------------------------------- 4
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          correct: 2,
          feedback: {
            ar: 'الطفل الذي يسعل بقوة ووجهه بلونه الطبيعي ويستطيع الكلام يعني أن مجرى هواؤه لم يُسدّ كلياً — والسعال القوي هو الآلية الطبيعية الأكثر فاعلية لإخراج الجسم الغريب. ما دام السعال قوياً فلا تضربه على ظهره ولا تضغط على بطنه ولا تُدخل يدك في فمه: التدخّل الآن قد يُزحزح الجسم الغريب إلى انسداد كامل، ووضع اليد في الفم قد يدفعه أعمق. شجّعه على السعال، ابقَ معه، واتصل بالطوارئ.\n\nأمّا إذا توقّف السعال أو صار صامتاً، أو عجز عن الكلام أو التنفّس، أو ازرقّ وجهه — فهذا انسداد كامل وحالة مختلفة تماماً. هنا التدخّل واجب، لأنّ عدم التدخّل يعني الوفاة خلال دقائق. الإرشاد الدولي المعتمد (IFRC 2020) هو خمس ضربات على الظهر بين لوحَي الكتف، ثمّ خمس ضغطات بطنية، بالتناوب حتى يخرج الجسم أو يفقد الطفل وعيه — وعندها يبدأ الإنعاش ويستمرّ استدعاء الإسعاف.\n\nالفارق بين الحالتين هو السعال نفسه: ما دام يسعل فالمجرى مفتوح جزئياً وجسمه يقوم بالمهمّة أفضل منك، وإذا صمت فالمجرى مسدود وصار التدخّل هو الإنقاذ.',
            en: 'A child who is coughing forcefully, whose face is its normal colour and who can speak means their airway is not completely blocked — and forceful coughing is the most effective natural mechanism for dislodging the foreign object. While the coughing is still forceful, do not slap their back, do not press on their abdomen and do not put your fingers in their mouth: intervening now can shift the object into a complete blockage, and a hand in the mouth can push it deeper. Encourage them to keep coughing, stay with them, and call the emergency services.\n\nIf the coughing stops or goes silent, or they cannot speak or breathe, or they turn blue, that is a complete blockage and an entirely different situation. Here you must intervene, because not intervening means death within minutes. The accepted international guidance — IFRC 2020 — is five back blows between the shoulder blades, then five abdominal thrusts, alternating until the object comes out or the child loses consciousness, at which point you begin resuscitation and keep the ambulance coming.\n\nThe difference between the two is the cough itself: while they are coughing the airway is only partly blocked and their body is doing this better than you could, and once they go silent the airway is blocked and intervening is the rescue.',
          },
        },
      ],
    },
