      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              ar: 'تتنازل وتنسحب تجنّباً للخلاف وتجد لنفسك مهمّة أخرى',
              en: 'Give way and withdraw to avoid conflict and find another task',
            },
            {
            ...
            {
              ar: 'تتجادلان حتى يقتنع أحدكما ويُكمل من قرأ التكليف صحيحاً',
              en: 'Argue until one of you is convinced, and whoever read it correctly finishes the setup',
            },
          ],
          correct: 2,
          feedback: {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              ar: 'تخبر القائد أن زميلك متأخّر ليعيد توزيع المهمّة',
              en: 'Tell the lead your teammate is behind so it gets reassigned',
            },
          ],
          correct: 2,
          feedback: {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              ar: 'تلوم من أعطاك الأرقام ليُبلغ القائد بنفسه',
              en: 'Blame whoever gave you the numbers so he tells the lead himself',
            },
          ],
          correct: 1,
          feedback: {
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            {
              ar: 'تحضر في الصباح وتشرح للقائد هناك أن المواد ناقصة، فهو غالباً يجد لها بديلاً من مستودع الموقع',
              en: 'Turn up in the morning and explain to the lead on site that the materials are missing, since he usually finds a substitute in the store there',
            },
            {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              ar: 'تؤجّل سفرك لأنك وعدت بالحضور',
              en: 'Postpone your travel, because you promised to come',
            },
          ],
          correct: 1,
          feedback: {
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            {
              ar: 'تصحّح أمام الأهالي فوراً وتوضّح أنها متطوّعة جديدة',
              en: 'Correct it in front of the families at once, explaining that she is a new volunteer',
            },
            {
            ...
            {
              ar: 'تصمت وتترك القائد يتصرّف لاحقاً، فالتصحيح ليس دورك',
              en: 'Stay quiet and let the lead deal with it later — correcting her is not your role',
            },
            {
