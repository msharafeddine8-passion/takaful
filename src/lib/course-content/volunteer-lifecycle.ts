      ...
      blocks: [
        ...
        },
        {
          ...
          content: {
            ...
            en: 'Reviewing the volunteer lifecycle at the end is not a formal procedure — but an institutional learning tool that identifies what worked and what needs improvement, to develop the organisation\'s capacity to attract, engage, and retain volunteers. Every departing volunteer offers a deeper understanding opportunity for the programme — provided this opportunity is invested in an organised exit interview and immediate documentation of observations.\n\nThe patterns that lifecycle reviews reveal over time give the organisation valuable signals: do volunteers leave disproportionately at particular points in the year? Are volunteers in certain roles less likely to stay than others? Is there a pattern in the reasons for leaving that points to a problem in the design rather than in the individuals? These questions are answered only by systematic documentation across several cycles.',
          },
        },
        {
          type: 'quiz',
