      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'الشاطئ غير قابل للإنقاذ — الأجدى نقل الجهد إلى موقع آخر أقلّ تلوّثاً', en: 'The beach is unsalvageable — the effort is better moved to a less polluted site' },
          ],
          correct: 0,
          feedback: {
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'حملة تنظيف موسمية بمشاركة المدارس تُبقي القضية حاضرة في المنطقة', en: 'A seasonal cleaning campaign with school participation that keeps the issue present locally' },
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'توثيق الحدث بالصور ومشاركتها على نطاق واسع لرفع الوعي واجتذاب متطوّعين جدد للموسم القادم', en: 'Documenting the event with photos and sharing them widely to raise public awareness and attract new volunteers for the next season' },
          ],
          correct: 0,
          feedback: {
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'وافق — أي تشجير أفضل من لا تشجير، والموقع السياحي يمنح الحملة ظهوراً يجذب تمويلاً لاحقاً', en: 'Agree — any greening is better than none, and a visible tourist site gives the campaign reach that attracts funding later' },
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'المتطوّعون يتعبون من الري اليومي ويحتاجون جدول تناوب أسبوعياً يُوزّع العبء', en: 'Volunteers tire of daily irrigation and need a weekly rotation schedule that spreads the load' },
          ],
          correct: 0,
          feedback: {
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'نظّم حفلات توعية بيئية متكرّرة لبناء ثقافة الحفاظ على البيئة لدى السكّان', en: 'Organise repeated environmental awareness events to build a conservation culture among residents' },
      ...
      blocks: [
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'ما الأنشطة التطوّعية التي يمكن تنفيذها خلال الزيارة لتكون الرحلة مفيدة للمنطقة لا مجرّد نزهة ترفيهية؟', en: 'What volunteer activities can be carried out during the visit so the trip benefits the area rather than being a recreational outing?' },
          ],
          correct: 0,
          feedback: {
        ...
        },
        {
          ...
          options: [
            ...
            { ar: 'ارفض لأن اقتراحات وسائل التواصل لا تُوثَق علمياً، واعتمد أدلّة التشجير المعتمدة', en: 'Refuse because social media suggestions are not scientifically validated, and rely on the approved planting guides' },
          ],
          correct: 0,
          feedback: {
