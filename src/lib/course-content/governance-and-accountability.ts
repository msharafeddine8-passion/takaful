      ...
      blocks: [
        ...
        },
        {
          ...
          content: {
            ...
            en: 'Building complaints and accountability mechanisms in the organisation is not a crisis response — but a preventive investment that averts larger crises. An organisation with a clear, activated complaints mechanism sends an implicit message to its beneficiaries and volunteers: "your voice is heard and we will act on what you report." This trust cannot be purchased with announcements.\n\nAn effective mechanism answers four questions clearly: how do I submit a complaint? Who will process it? In how much time will it be processed? And how will I know the outcome? The absence of any of these answers reduces the mechanism\'s effectiveness and entrenches a feeling that complaints are filed in a drawer that is never opened.\n\nInternal accountability mechanisms also include the periodic review of management and financial decisions: who reviews the major decisions? And how does the organisation know that what is decided is actually carried out? The board, or whichever body holds the remit, is expected to balance oversight against trust — excessive oversight paralyses, and blind trust leaves the door open to corruption.\n\nDocumenting governance decisions and the reasons behind them provides an institutional memory that protects the organisation from conflicting accounts as one leadership succeeds another. A decision taken for sound reasons years ago can look incomprehensible once half the board has changed — unless it was recorded with its full context. Strong governance means the institutional memory is held in the documents, not in individuals\' heads.',
          },
        },
        {
          type: 'quiz',
